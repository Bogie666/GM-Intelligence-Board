...
The application release is compiled to require the exact database marker `20260818001200_atomic_qa_portfolio_cleanup`; the expected marker is intentionally not environment-configurable.
