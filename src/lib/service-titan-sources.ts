...
export const serviceTitanEndpointRecipes: ServiceTitanEndpointRecipe[] = [
  ...
  { id: "inbound-call-booking-rate", version: 2, name: "Inbound call booking rate", description: "Inbound calls with a job number attached divided by non-abandoned inbound calls for the period.", capability: "call-center", outputKind: "percent", defaultRefreshInterval: "30m", allowedRefreshIntervals: ["15m", "30m", "1h", "4h"], lineage: "Call Center + booking attachment" },
  ...
  { id: "membership-net-growth", version: 1, name: "Membership net growth", description: "Memberships created minus memberships canceled during the period.", capability: "memberships", outputKind: "number", defaultRefreshInterval: "4h", allowedRefreshIntervals: ["1h", "4h", "12h", "24h"], lineage: "Customer memberships + creation and cancellation windows" },
