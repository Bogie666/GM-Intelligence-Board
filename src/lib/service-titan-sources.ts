...
export const serviceTitanEndpointRecipes: ServiceTitanEndpointRecipe[] = [
  ...
  { id: "new-memberships", version: 1, name: "New memberships", description: "Customer memberships created during the period, filtered through governed business-unit mappings.", capability: "memberships", outputKind: "number", defaultRefreshInterval: "4h", allowedRefreshIntervals: ["1h", "4h", "12h", "24h"], lineage: "Customer memberships + creation window" },
  { id: "canceled-memberships", version: 1, name: "Canceled memberships", description: "Customer memberships whose cancellation date falls inside the period.", capability: "memberships", outputKind: "number", defaultRefreshInterval: "4h", allowedRefreshIntervals: ["1h", "4h", "12h", "24h"], lineage: "Customer memberships + cancellation window" },
  { id: "membership-net-growth", version: 1, name: "Membership net growth", description: "Memberships created minus memberships canceled or expired (effective end) during the period.", capability: "memberships", outputKind: "number", defaultRefreshInterval: "4h", allowedRefreshIntervals: ["1h", "4h", "12h", "24h"], lineage: "Customer memberships + creation and effective-end windows" },
